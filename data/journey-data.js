const protest = {
    ...
    choices: [{
        ...
        result: 'You help put an end to the protest and everyone goes their own way.  34 protesters are arrested and 12 protesters are sent to the hospital from police related injuries.  You later find out in the news that police planted people to start the violence, giving them a reason to stop the protest.',
        govermentStanding: ,
        money: 
    }, {
        id: 'do-nothing',
        ...
        id: 'help-protesters',
        descripton: 'You feel strongly about citizens\' privacy rights and step in to fight back against the man.  You try to stop the cops from moving forward but you get overpowered and thrown to the ground.  Fortunately you\'re not arrested and manage to espace.',
        result: ,
        govermentStanding: ,
        money:
    }
...
const eminantDomain = {
    ...
    choices: [{
        ...
        result: 'The government steps in and makes the land grab.  They are able to pay off their debts and even have extra funds which could be used to serve the people, but instead are placed in the politicians pocket.',
        govermentStanding: ,
        money: 
    }, {
        id: 'do-nothing',
